...
<!-- akhir navbar -->
  ...
  <!-- awal content -->
    <div class="container">
      ...
      <table class="table">
        ...
        <tbody>
          <?php for ($i=0; $i <count($hasil['Items']) ; $i++) { ?>
          <tr>
            <td><?php echo $i+1; ?></td>
            <td><?php echo $hasil['Items'][$i]['CustomerName']; ?></td>
            <td><?php echo $hasil['Items'][$i]['TenantDomain']; ?></td>
            <td><?php echo $hasil['Items'][$i]['TenantStatus']; ?></td>
          </tr>
         <?php } ?>
        </tbody>
      </table>
  ...
  <!-- akhir content -->
    ...
    <script src="https://code.jquery.com/jquery-3.4.1.min.js" integrity="a256-CSXorXvZcTkaix6Yvo6HppcZGetbYMGWSFlBw8HfCJo=" crossorigin="anonymous"></script>
